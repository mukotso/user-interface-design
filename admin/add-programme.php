                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="add-subjects.php">Unit Details</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Unit </strong><small> Details</small></div>
                            ...
                            <input class="form-control" placeholder="enter programme name"> </input>
                                              <p style="text-align: center;">
                                              </p>
                            </div>
                               
                                              <a href="manage-programmes.php" class="btn btn-primary btn-sm" name="submit" id="submit">
